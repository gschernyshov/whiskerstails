  ...
  return (
    ...
    >
      <button
        ...
        className="cursor-pointer absolute top-[-4px] left-[-4px] md:right-[-4px] p-2 bg-white rounded-full shadow-[0_0_5px_rgba(0,0,0,0.1)] text-red-500 hover:text-red-700 transition-all"
